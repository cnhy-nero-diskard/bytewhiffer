...
## Purpose
Define fail-closed CI and release delivery for reproducible Windows builds, required quality validation, dependency policy enforcement, and verifiable release artifacts.
